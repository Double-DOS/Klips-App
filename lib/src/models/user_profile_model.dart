...
class UserProfileModel {
  ...
  UserProfileModel.fromJson(Map<String, dynamic> jsonMap) {
    ...
    try {
      totalRecords =
          jsonMap['totalRecords'] != null ? jsonMap['totalRecords'] : 0;
      totalVideosLike =
          jsonMap['totalVideosLike'] != null ? jsonMap['totalVideosLike'] : '';
      totalFollowings = jsonMap['totalFollowings'] != null
          ? jsonMap['totalFollowings'].toString()
          : '';
      totalFollowers = jsonMap['totalFollowers'] != null
          ? jsonMap['totalFollowers'].toString()
          : '';
      totalVideos = jsonMap['totalVideos'] != null ? jsonMap['totalVideos'] : 0;
      blocked = jsonMap['blocked'] != null ? jsonMap['blocked'] : '';
      largeProfilePic =
          jsonMap['large_pic'] != null ? jsonMap['large_pic'] : '';
      smallProfilePic =
          jsonMap['small_pic'] != null ? jsonMap['small_pic'] : '';
      ...
      userVideos =
          jsonMap['data'] != null ? parseAttributes(jsonMap['data']) : [];
      isVerified = jsonMap['isVerified'] != null
          ? jsonMap['isVerified'] == 1
              ? true
              : false
          : false;
      isHawaiiVerified = jsonMap['userVerified'] != null
          ? jsonMap['userVerified'] == 1
              ? true
              : false
          : false;
    } catch (e) {
  ...
  Map toMap() {
    ...
    map["isHawaiiVerified"] = this.isHawaiiVerified;
