...
class Video {
  ...
  Video.fromJSON(Map<String, dynamic> json) {
    ...
    totalFollowers =
        json["total_followers"] == null ? 0 : json['total_followers'];
    ...
    userDP = json['user_dp'];
    soundImageUrl =
        json['sound_image_url'] == null ? '' : json['sound_image_url'];
    ...
    isVerified = json['isVerified'] != null
        ? json['isVerified'] == 1
            ...
            : false
        : false;
    isHawaiiVerified = json['userVerified'] != null
        ? json['userVerified'] == 1
            ? true
            : false
        : false;
  ...
  Map<String, dynamic> toJson() {
    ...
    data['isHawaiiVerified'] = this.isHawaiiVerified;
