...
class Helper {
  ...
  static String getApiUser() {
    print("getApiUser");
    print(GlobalConfiguration().getValue('api_user'));
    String apiUser = GlobalConfiguration().getValue('api_user');
    return apiUser.toString();
  }

  static String getApiKey() {
    print("getApiKey");
    print(GlobalConfiguration().getValue('api_key'));
    String apiKey = GlobalConfiguration().getValue('api_key');
    return apiKey;
  }
