...
import 'package:Leuke/src/views/verifyIcon.dart';
...
class UsersProfileView extends StatefulWidget {
  ...
  final int userId;
  UsersProfileView({Key key, this.userId, this.parentScaffoldKey})
      : super(key: key);
              ...
              return Scaffold(
                ...
                appBar: PreferredSize(
                  ...
                  child: AppBar(
                    ...
                    backgroundColor:
                        settingRepo.setting.value.bgColor.withOpacity(0.60),
                    title: Text(
                      "PROFILE PICTURE",
                      style: TextStyle(
                        fontSize: 18.0,
                ...
                body: Center(
                  child: PhotoView(
                    enableRotation: true,
                    imageProvider: CachedNetworkImageProvider((userProfile
                                .largeProfilePic
                                .toLowerCase()
                                .contains(".jpg") ||
              ...
              decoration: new BoxDecoration(
                image: new DecorationImage(
                  image: userProfile.smallProfilePic != null
                      ? CachedNetworkImageProvider((userProfile.smallProfilePic
                                  .toLowerCase()
                                  .contains(".jpg") ||
            ...
            itemBuilder: (BuildContext context, int i) {
              return /*AnimationConfiguration.staggeredList(
                ...
                child: SlideAnimation(
                  ...
                  GestureDetector(
                onTap: () async {
                  videoRepo.homeCon.value.userVideoObj.value['userId'] =
                      userProfile.userVideos[i].userId;
                  videoRepo.homeCon.value.userVideoObj.value['videoId'] =
                      userProfile.userVideos[i].videoId;
                  videoRepo.homeCon.value.userVideoObj.value['name'] =
                      userProfile.name.split(" ").first + "'s";
                ...
                child: Container(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(
                          settingRepo.setting.value.gridBorderRadius),
                      boxShadow: [
                        BoxShadow(
                                ...
                                Expanded(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        userProfile.userVideos[i].totalLikes
                                            .toString(),
                                        style: TextStyle(
                                          fontSize: 11,
                                          color: settingRepo
                                ...
                                Expanded(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        Helper.formatter(userProfile
                                            .userVideos[i].totalViews
                                            .toString()),
                                        style: TextStyle(
                                          fontSize: 11,
                                          color: settingRepo
      ...
      children: <Widget>[
        ...
        Row(
          ...
          children: [
            ...
            userProfile.isHawaiiVerified == true
                ? VerifyIcon(size: 16)
                                                  ...
                                                  InkWell(
                                                    ...
                                                    onTap: () {
                                                      if (currentUser
                                                        ...
                                                        _con.followUnfollowUserFromUserProfile(
                                                            widget.userId);
                                                      }
                                                    },
                                                  ),
