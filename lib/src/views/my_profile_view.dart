                    ...
                    child: Column(
                      children: [
                        ...
                        Expanded(
                          child: Center(
                            child:
                                userProfile.userVideos[i].videoThumbnail != ""
                                    ? Container(
                                    ...
                                    onSelected: (int) {
                                      if (int == 0) {
                                        ...
                                        _con.showDeleteAlert(
                                            "Delete Confirmation",
                                            "Do you realy want to delete the video",
                                            userProfile.userVideos[i].videoId);
                                      }
                                    },
                                    itemBuilder: (context) => [
                                ...
                                children: <Widget>[
                                  Container(
                                    ...
                                    child: DrawerHeader(
                                      ...
                                      decoration: BoxDecoration(
                                        color:
                                            Color(0XFF15161a).withOpacity(0.1),
                                        border: Border(
                                          bottom: BorderSide(
                                            width: 0.5,
                                            color: settingRepo
                            ...
                            children: <Widget>[
                                  ...
                                  child: Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      InkWell(
                                          ...
                                          onTap: () {
                                            _con.userScaffoldKey.currentState
                                                .openEndDrawer();
                                          }),
                              ...
                              Container(
                                ...
                                child: Container(
                                  ...
                                  child: Container(child: tabs(userProfile)),
                                ),
                              ),
                            ],
                          ),
