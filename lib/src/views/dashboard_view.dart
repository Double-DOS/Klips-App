...
class _DashboardWidgetState extends StateMVC<DashboardWidget>
    ...
    if (state.toString() == "AppLifecycleState.paused" ||
      ...
      if (!videoRepo.homeCon.value.showFollowingPage.value ||
        ...
        videoRepo.homeCon.value
            ...
            ?.pause();
      } else if (videoRepo.homeCon.value.showFollowingPage.value) {
        videoRepo.homeCon.value
            .videoController2(videoRepo.homeCon.value.swiperIndex2)
            ?.pause();
      } else {
        videoRepo.homeCon.value
            .videoController3(videoRepo.homeCon.value.swiperIndex2)
            ?.pause();
      }
      ...
      if (!videoRepo.homeCon.value.showFollowingPage.value ||
        ...
        _con.playController3(videoRepo.homeCon.value.swiperIndex);
      }
    }
  }
  ...
  dispose() async {
    if (!videoRepo.homeCon.value.showFollowingPage.value ||
      ...
      videoRepo.homeCon.value
          .videoController3(videoRepo.homeCon.value.swiperIndex3)
          ?.pause();
    }
    if (!videoRepo.firstLoad.value) {
      print("not first load");
      int count = 0;
      print(videoRepo.homeCon.value.videoControllers.length);
      ...
      int count2 = 0;
      if (videoRepo.homeCon.value.videoControllers3.length > 0) {
        videoRepo.homeCon.value.videoControllers3.forEach((key, value) async {
          await value.dispose();
          videoRepo.homeCon.value.videoControllers3.remove(
              videoRepo.followingUsersVideoData.value.videos.elementAt(count1));
          videoRepo.homeCon.value.initializeVideoPlayerFutures3.remove(
              videoRepo.followersUsersVideoData.value.videos.elementAt(count1));
          count1++;
        });
      }
    } else {
                                  ...
                                  onTap: () {
                                    if (videoRepo.homeCon.value
                                      ...
                                      _con
                                        ...
                                        .showFollowersPage.value) {
                                      _con
                                          .videoController3(videoRepo
                                              .homeCon.value.swiperIndex3)
                                          .play();
                                    } else {
                                      _con
                  ...
                  RefreshIndicator(
                    onRefresh: () {
                      if (!videoRepo.homeCon.value.showFollowingPage.value &&
                        ...
                        videoRepo.homeCon.value
                            .videoController3(
                                videoRepo.homeCon.value.swiperIndex3)
                            ?.pause();
                      }
            ...
            Container(
              decoration: BoxDecoration(
                gradient: LinearGradient(
                    ...
                    colors: [Colors.green.withOpacity(0.1), Colors.green[400]]),
                // image: DecorationImage(
                //     image: AssetImage('assets/icons/bottom bg.svg')),
              ),
              child: Padding(
                  ...
                  children: [
                        ...
                        IconButton(
                          ...
                          onPressed: () async {
                            ...
                            if (!videoRepo
                                    .homeCon.value.showFollowingPage.value &&
                                !videoRepo
                                    .homeCon.value.showFollowersPage.value) {
                              videoRepo.homeCon.value
                                  .videoController(
                                      videoRepo.homeCon.value.swiperIndex)
                                  ?.pause();
                    ...
                    Container(
                      child: IconButton(
                        ...
                        padding: EdgeInsets.all(0),
                        icon: Image.asset(
                          "assets/icons/vid.player-icon.png",
                          width: 120,
                          color: settingRepo.setting.value.dashboardIconColor,
                        ),
                        onPressed: () async {
                        ...
                        */ /* Image.asset(
                        ...
                        onPressed: () async {
                          ...
                          if (!videoRepo.homeCon.value.showFollowingPage.value || !videoRepo.homeCon.value.showFollowersPage.value) {
                        ...
                        IconButton(
                          ...
                          onPressed: () async {
                            ...
                            if (!_con.showFollowingPage.value &&
                                !_con.showFollowersPage.value) {
                              _con.videoController(_con.swiperIndex)?.pause();
                            } else if (_con.showFollowingPage.value) {
                              _con.videoController2(_con.swiperIndex2)?.pause();
                            } else {
                              _con.videoController3(_con.swiperIndex3)?.pause();
                            }
  ...
  Widget homeWidget() {
    ...
    if (!videoRepo.homeCon.value.showFollowingPage.value &&
      ...
      videoObj = (followersUsersVideoData.value.videos.length > 0)
    ...
    return (videoObj != null)
        ? SlidingUpPanel(
                    ...
                    child: (videoRepo.homeCon.value.comments.length > 0)
                        ? Padding(
                            ...
                            child: ListView.separated(
                              controller:
                                  videoRepo.homeCon.value.scrollController,
                              padding: EdgeInsets.zero,
                              scrollDirection: Axis.vertical,
                              itemCount:
                                  videoRepo.homeCon.value.comments.length,
                                ...
                                return Column(
                                  children: [
                                    ListTile(
                                      ...
                                      trailing: userRepo.currentUser.value
                                                      .userId ==
                                                  videoRepo
                                                      .homeCon.value.comments
                                                      .elementAt(i)
                        ...
                        : (videoObj.totalComments > 0)
                            ? SkeletonLoader(
                                ...
                                items: videoObj.totalComments > 4
                                    ? 4
                                ...
                                children: [
                                  ...
                                  IconButton(
                                    ...
                                    onPressed: () {
                                      setState(() {
                                        videoRepo.homeCon.value
                                            .textFieldMoveToUp = false;
                                      });
                                      if (videoRepo.homeCon.value.commentValue
                                                  .trim() !=
                                              '' &&
                                          videoRepo
                                                  .homeCon.value.commentValue !=
                                              null) {
                                        print("editedComment");
                                        print(videoRepo
                                            .homeCon.value.editedComment.value);
                                        editCommentIndex > 0
                                            ? videoRepo.homeCon.value
                                                .editComment(
                                                    videoRepo
            ...
            body: ValueListenableBuilder(
              valueListenable: videoRepo.homeCon.value.showFollowersPage,
              builder: (context, show, _) {
                return show
                    ? ValueListenableBuilder(
                        valueListenable: followersUsersVideoData,
                        builder: (context, VideoModel video, _) {
                          print("videoRepo.homeCon.value.swiperIndex3");
                          print(videoRepo.homeCon.value.swiperIndex3);
                          return Stack(
                            children: <Widget>[
                              (video.videos.length > 0)
                                  ? Swiper(
                                      controller: videoRepo
                                          .homeCon.value.swipeController3,
                                      loop: false,
                                      index:
                                          videoRepo.homeCon.value.swiperIndex3,
                                      ...
                                      onIndexChanged: (index) {
                                        if (videoRepo
                                            ...
                                            index) {
                                          videoRepo.homeCon.value
                                              .previousVideo3(index);
                                        } else {
                                          videoRepo.homeCon.value
                                              .nextVideo3(index);
                                        }
                                        videoRepo.homeCon.value
                                            .updateSwiperIndex3(index);
                                        if (video.videos.length - index == 3) {
                                          videoRepo.homeCon.value
                                              .listenForMoreUserFollowersVideos();
                                        }
                                      },
                                      itemBuilder:
                                          ...
                                          child: Container(
                                            child: Column(
                                              ...
                                              children: <Widget>[
                                                ...
                                                Text(
                                                  "This is your feed of users that follow you.",
                                                  style: TextStyle(
                                                      color: Colors.white,
                                                      fontSize: 15,
                                                      fontWeight:
                                  ...
                                  builder: (context, VideoModel video, _) {
                                    return Stack(
                                      children: <Widget>[
                                        ...
                                        ValueListenableBuilder(
                                            valueListenable: videoRepo
                                                .homeCon.value.userVideoObj,
                                            builder: (context,
                                                Map<String, dynamic> value, _) {
                                  ...
                                  builder: (context, VideoModel video, _) {
                                    ...
                                    return Stack(
                                      children: <Widget>[
                                        (video.videos.length > 0)
                                            ? Swiper(
                                                controller: videoRepo.homeCon
                                                    .value.swipeController2,
                                                loop: false,
                                                index: videoRepo
                                                    .homeCon.value.swiperIndex2,
                                                control: new SwiperControl(
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: <Widget>[
                ...
                onTap: () async {
                  if (!videoRepo.homeCon.value.showFollowingPage.value &&
                    ...
                    videoRepo.homeCon.value
                        .videoController2(videoRepo.homeCon.value.swiperIndex2)
                        ?.pause();
                    videoRepo.homeCon.value.showFollowersPage.value = false;
                    videoRepo.homeCon.value.showFollowersPage.notifyListeners();
                    videoRepo.homeCon.value
                        .videoController3(videoRepo.homeCon.value.swiperIndex3)
                        ?.pause();
                    // videoRepo.homeCon.value
              ...
              //       }),
              //   onTap: () async {
              //     videoRepo.homeCon.value.showFollowersPage.value = true;
              //     videoRepo.homeCon.value.showFollowersPage.notifyListeners();
              //     if (!videoRepo.homeCon.value.showFollowingPage.value) {
              //       videoRepo.homeCon.value
              //           .videoController3(videoRepo.homeCon.value.swiperIndex3)
        ...
        if (currentUser.value.token != null) {
          if (!videoRepo.homeCon.value.showFollowingPage.value) {
            ...
            videoRepo.homeCon.value
                .videoController3(videoRepo.homeCon.value.swiperIndex2)
                ?.pause();
          } else if (!videoRepo.homeCon.value.showFollowersPage.value) {
            videoRepo.homeCon.value
                .videoController(videoRepo.homeCon.value.swiperIndex)
                ?.pause();
            videoRepo.homeCon.value
                .videoController2(videoRepo.homeCon.value.swiperIndex)
                ?.pause();
          } else {
            videoRepo.homeCon.value
                .videoController3(videoRepo.homeCon.value.swiperIndex3)
                    ...
                    Container(
                      ...
                      child: IconButton(
                        ...
                        onPressed: () {
                          ...
                          videoRepo.homeCon.value.showBannerAd.value = false;
                          videoRepo.homeCon.value.showBannerAd
                              .notifyListeners();
                      ...
                      builder: (context, shareLoader, _) {
                        return (!shareLoader)
                            ? IconButton(
                                ...
                                onPressed: () async {
                                  videoRepo.homeCon.value.shareShowLoader
                                      .value = true;
                                  videoRepo.homeCon.value.shareShowLoader
                                      .notifyListeners();
                                  Share.share(
                                      '${GlobalConfiguration().get('share_text')}');
                                  await Future.delayed(
                                    Duration(seconds: 2),
                                  );
                                  videoRepo.homeCon.value.shareShowLoader
