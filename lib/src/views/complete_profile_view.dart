...
class _CompleteProfileViewState extends StateMVC<CompleteProfileView>
  ...
  void initState() {
    ...
    if (userRepo.socialUserProfile.value != null) {
      ...
      setState(() {
        ...
        if (userRepo.socialUserProfile.value.email == null ||
            userRepo.socialUserProfile.value.email == null) {
        } else {
          _con.profileEmailController = TextEditingController(
              text: userRepo.socialUserProfile.value.email);
        }
      });
    }
    super.initState();
                              ...
                              Navigator.of(context)
                                ...
                                return Scaffold(
                                    ...
                                    body: Center(
                                      child: PhotoView(
                                        enableRotation: true,
                                        imageProvider: userRepo
                                                    .socialUserProfile
                                                    .value
                                                    .userDP !=
                                                ''
                                            ? CachedNetworkImageProvider(
                                                userRepo.socialUserProfile.value
                                                    .userDP)
                                            : AssetImage(
                                                "assets/images/p-icon2.png"),
                                      ),
                                    ));
                              }));
                              _con.pc.close();
                                ...
                                child: Column(
                                  children: <Widget>[
                                    ...
                                    TextFormField(
                                      ...
                                      enabled: userRepo.socialUserProfile.value
                                                      .email ==
                                                  "" ||
                                              userRepo.socialUserProfile.value
                                                      .email ==
...
//                    contentPadding: EdgeInsets.fromLTRB(20.0, 25.0, 20.0, 15.0),
                                    ...
                                    TextFormField(
                                      ...
                                      keyboardType: TextInputType.multiline,
                                      controller:
                                          _con.profileUsernameController,
                                      style: TextStyle(
                                        fontFamily: 'RockWellStd',
                                        fontSize: 18.0,
                                        color:
                                      ...
                                      child: Theme(
                                        ...
                                        child: Align(
                                          ...
                                          child: DropdownSearch<Gender>(
                                            ...
                                            popupBackgroundColor: settingRepo
                                                .setting.value.bgColor,
                                            popupBarrierColor: settingRepo
                                                        .setting
                                                        .value
                                                        .dividerColor !=
                                                    null
